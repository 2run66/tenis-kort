...
class WireframeDetector(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        model_device = torch.device(cfg.MODEL.DEVICE) # Add this line
        self.register_buffer('tspan', torch.linspace(0, 1, self.n_pts0)[None,None,:].to(model_device)) # Modify this line
